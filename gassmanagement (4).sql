...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 25, 2017 at 03:59 AM
...
--
-- Table structure for table `order_alokasi`
--

CREATE TABLE `order_alokasi` (
  `oa_id` int(11) NOT NULL,
  `oa_equipment` int(11) NOT NULL,
  `oa_many` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `order_alokasi`
--
ALTER TABLE `order_alokasi`
  ADD PRIMARY KEY (`oa_id`),
  ADD KEY `oa_equipment` (`oa_equipment`),
  ADD KEY `oa_many` (`oa_many`);
...
--
-- AUTO_INCREMENT for table `order_alokasi`
--
ALTER TABLE `order_alokasi`
