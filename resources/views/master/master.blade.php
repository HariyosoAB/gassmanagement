...
<body>
	<div class="head">
		...
		<div class="notif"><button id="profil">Hi, <?php $nama = explode(' ', Auth::user()->user_nama); echo $nama[0];  ?></button><button id="nav-mobile"><i class="fa fa-bars" aria-hidden="true"></i></button></div>
		<div id="profil-menu">
