...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 18, 2017 at 02:13 PM
...
CREATE TABLE `order_f` (
  ...
  `order_airline` varchar(200) NOT NULL,
  `order_note` varchar(2000) NOT NULL,
  `order_end` datetime NOT NULL,
  `order_status` int(11) NOT NULL,
  `order_operator` int(11) NOT NULL,
  `order_wingman` int(11) NOT NULL,
...
(1, 'ario bimo', 'admin', 'GSE', 'PG', '0812221923', 'masgondi234@yahoo.com', 'management', 1, '$2y$10$sJ2V8gV6/QYqoi/6ASmlCuz/liZXaApEHmwKVfCYWDejk9cs.bpYm', 'M7TkZibXFYvE9RsmhT7zL1pBlqMKi6KJIZBLNW9ukexO36eM73GmrAdnkE3H');
...
--
ALTER TABLE `actype`
  MODIFY `actype_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `urgency`
  MODIFY `urgency_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `order_status`
  ...
  ADD CONSTRAINT `order_status_ibfk_2` FOREIGN KEY (`os_status`) REFERENCES `root_cause` (`rc_id`) ON DELETE CASCADE;

--
-- Constraints for table `problem_tagging`
--
ALTER TABLE `problem_tagging`
  ADD CONSTRAINT `problem_tagging_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `order_f` (`order_id`) ON DELETE CASCADE;
